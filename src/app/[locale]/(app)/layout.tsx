...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const [casaActiva, perfil, t] = await Promise.all([getCasaActiva(), getPerfilPropio(), getTranslations('Nav')]);
  ...
  const saludo = perfil?.nombre ? t('saludo', { nombre: perfil.nombre }) : user.email;
